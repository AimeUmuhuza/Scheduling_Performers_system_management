...
class EventRepository {
    ...
    async updateEvent(values) {
        try {
            const response = await Repository.put(`${baseUrl}/event`,values, {
                headers: {
                    Authorization: 'Bearer '+getUserData().authenticationToken,
                },
            });
    ...
    async deleteEvent(eventId) {
        try {
            const response = await Repository.delete(`${baseUrl}/event/${eventId}`, {
                headers: {
                    Authorization: 'Bearer '+getUserData().authenticationToken,
                },
            });
    ...
    async createEventPerformance(artistId,eventId,values) {
        try {
            const response = await Repository.post(`${baseUrl}/time/${artistId}/${eventId}`,values, {
                headers: {
                    Authorization: 'Bearer '+getUserData().authenticationToken,
                },
            });
    ...
    async deletePerformanceTime(timeId) {
        try {
            const response = await Repository.delete(`${baseUrl}/time/${timeId}`, {
                headers: {
                    Authorization: 'Bearer '+getUserData().authenticationToken,
                },
            });
